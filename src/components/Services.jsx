    ...
    return (
        <>
            <section className="container py-5 border-bottom">
                ...
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 py-4 mx-3 shadow-lg rounded-4">

                    <div className="col text-center p-4 my-2">
                        <img className="img-fluid mb-4 rounded-4" src="./services1.webp" alt="Services Image" />
                    ...
                    <div className="col text-center p-4 my-2">
                        <img className="img-fluid mb-4 rounded-4" src="./services2.webp" alt="Services Image" />
                    ...
                    <div className="col text-center p-4 my-2">
                        <img className="img-fluid mb-4 rounded-4" src="./services3.webp" alt="Services Image" />
